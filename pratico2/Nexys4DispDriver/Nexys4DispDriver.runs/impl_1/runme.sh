...
HD_PWD='C:/Users/jcoel/Desktop/CR/pratico2/Nexys4DispDriver/Nexys4DispDriver.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DisplayDemo.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DisplayDemo.tcl -notrace
