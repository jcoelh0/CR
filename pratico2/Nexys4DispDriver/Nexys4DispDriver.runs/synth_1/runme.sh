...
HD_PWD='C:/Users/jcoel/Desktop/CR/pratico2/Nexys4DispDriver/Nexys4DispDriver.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DisplayDemo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DisplayDemo.tcl
