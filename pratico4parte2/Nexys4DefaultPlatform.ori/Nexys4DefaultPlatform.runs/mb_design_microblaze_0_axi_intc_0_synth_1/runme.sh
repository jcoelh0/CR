...
HD_PWD='C:/Users/jcoel/Desktop/CR/pratico4parte2/Nexys4DefaultPlatform.ori/Nexys4DefaultPlatform.runs/mb_design_microblaze_0_axi_intc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_design_microblaze_0_axi_intc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mb_design_microblaze_0_axi_intc_0.tcl
