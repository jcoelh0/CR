...
HD_PWD='C:/Users/jcoel/Desktop/CR/pratico3/CountDownTimerSoftware/CountDownTimerSoftware.runs/mb_design_axi_timer_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_design_axi_timer_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mb_design_axi_timer_0_0.tcl
