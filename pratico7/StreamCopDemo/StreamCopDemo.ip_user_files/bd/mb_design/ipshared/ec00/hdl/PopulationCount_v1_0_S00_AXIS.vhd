...
entity PopulationCount_v1_0_S00_AXIS is
	generic (
...
end PopulationCount_v1_0_S00_AXIS;

architecture arch_imp of PopulationCount_v1_0_S00_AXIS is
	...
	begin
        if (rising_edge (S_AXIS_ACLK)) then
	        if (S_AXIS_ARESETN = '0') then
	           ...
	           if (s_ready = '1') then
                    s_validOut <= '1';
	                s_dataOut  <= S_AXIS_TDATA(31 downto 0);
	           end if;
