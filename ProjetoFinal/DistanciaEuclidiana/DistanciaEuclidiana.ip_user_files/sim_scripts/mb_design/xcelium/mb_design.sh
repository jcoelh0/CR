...
execute()
{
  xrun $xrun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"../../../../../../pratico7/Nexys4DefaultPlatform.ori/Nexys4DefaultPlatform.srcs/sources_1/bd/mb_design/ipshared/ec67/hdl" \
       +incdir+"../../../../../../pratico7/Nexys4DefaultPlatform.ori/Nexys4DefaultPlatform.srcs/sources_1/bd/mb_design/ipshared/4fba"
}
