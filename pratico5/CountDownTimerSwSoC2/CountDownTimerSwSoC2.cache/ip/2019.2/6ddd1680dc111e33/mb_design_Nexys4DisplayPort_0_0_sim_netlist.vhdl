...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Nexys4DisplayDriver is
  ...
  signal \dispSeg_n[6]_INST_0_i_2_n_0\ : STD_LOGIC;
  signal \dispSeg_n[6]_INST_0_i_3_n_0\ : STD_LOGIC;
  signal \dispSeg_n[6]_INST_0_i_4_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \dispEn_n[0]_INST_0\ : label is "soft_lutpair6";
  ...
  attribute SOFT_HLUTNM of \dispEn_n[3]_INST_0\ : label is "soft_lutpair3";
  ...
  attribute SOFT_HLUTNM of \s_digCnt[1]_i_1\ : label is "soft_lutpair7";
...
\s_digCnt[0]_i_1\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\s_digCnt[1]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\s_digCnt[2]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"78"
    )
        port map (
