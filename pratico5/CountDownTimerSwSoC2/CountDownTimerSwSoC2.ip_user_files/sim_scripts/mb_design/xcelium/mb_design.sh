...
execute()
{
  xrun $xrun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"../../../../../CountDownTimerSwSoC/CountDownTimerSwSoC.srcs/sources_1/bd/mb_design/ipshared/4fba" \
       +incdir+"../../../../../CountDownTimerSwSoC/CountDownTimerSwSoC.srcs/sources_1/bd/mb_design/ipshared/ec67/hdl"
}
